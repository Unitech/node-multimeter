var Bar = module.exports = function (charm, x, y, params) {
    ...
    this.before = params.before || Bar.defaultStyle.before;
    this.after = params.after || Bar.defaultStyle.after;
    
    this.solid = params.solid || Bar.defaultStyle.solid;
    
    this.empty = params.empty || Bar.defaultStyle.empty;
